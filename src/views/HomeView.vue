...
<p>
  Hover over a card!
	...
	<!-- Link to page
	================================================== -->
  <a class="logo hover-target" target="_blank">
    <img src="https://i.postimg.cc/PJM7dyMR/images-25.jpg" alt="Logo" style="border-radius: 50%;" />
	</a>
...
.hero-section {
	...
	overflow: hidden;
	height: 100vh;
	background-image: url('https://i.ibb.co/zZ5NH9P/ai-generated-8657280-1280.jpg"');
